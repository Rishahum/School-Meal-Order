  ...
  return (
    <Center height={'100vh'}>
      ...
      <Box
        ...
        width="60vw"
      // {...props} // Allow other props (e.g., children, margin, etc.)
      >
        <Heading as='h4' size='md' marginBottom={'12px'}>
          LOGIN
        </Heading>
        <Input variant="secondary" placeholder='mail id' size='md' marginBottom={'12px'} />
      ...
      <Flex bg={"green.200"} borderRadius={'6px'} padding={'6px'}>
        Not Registered ?
        <Text color="red.300" marginLeft={'5px'} onClick={handleRoute}>Register</Text>
      </Flex>
      </Box>
    </Center>
  );
